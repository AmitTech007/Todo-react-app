...
const aboutData = [
  ...
  },
  {
    ...
    description:
      'Mr. Amit Yadav founded amitlogic.com to experiment with new web features and write actionable guides. Follow Ibas on Twitter @ibaslogic to learn modern web development.',
  },
];
